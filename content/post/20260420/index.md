...
updated: 2026-05-20 06:38
---

# Power Pages를 호스팅처럼 이용하게 되면 겪는 일
AI라는 미명 아래 이런저런 코딩을 하다보면, 그리고 M365 플랫폼을 쓰는 회사에 근무하다 보면 결국 Microsoft가 제공해주는 플랫폼 안에서 결과물을 보여줘야 한다.<br>총무팀에게 맘껏 개발하라고 '개발 서버'를 주는 회사는 없을 테니까... 😇<br>급기야 대안을 찾아다 Power Platforms 안에 있는 Power Pages의 웹 리소스 기능을 마치 호스팅 서버 마냥 이용하게 되었다.<br>기존에 내가 만들었던 [AI를 활용한 마스터플랜(Progress Tracker)]({{< relref "post/20260305/index.md" >}}), [AI를 활용한 Global Hotel Dashboard]({{< relref "post/20260317/index.md" >}}) 등 여러 프로젝트들도 모두 Power Pages에 업로드 되어 있다.<br>Power Pages를 활용했을 때 장점은 다음과 같다.
...
- Python은 호스팅 불가하므로 로컬 환경에서 테스트해야 한다. Streamlit으로 웹 페이지를 구성했다면 HTML 기반으로 다시 제작해야 한다. 😇
